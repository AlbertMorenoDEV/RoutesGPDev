//
//  MotoCorre2ViewController.m
//  RoutesGP
//
//  Created by ntl on 3/22/14.
...
#import "MotoCorre2ViewController.h"

@interface MotoCorre2ViewController ()
...
@implementation MotoCorre2ViewController
...
- (void)viewDidLoad
{
    ...
    tiempo = [NSTimer scheduledTimerWithTimeInterval:1 target:self selector:@selector(motoCorre:) userInfo:nil repeats:YES];
    
	// Do any additional setup after loading the view.
}

-(void)motoCorre:(id) sender
{
    ...
    agrupacionAnimaciones.animations = [NSArray arrayWithObjects:animation ,escalarAnimacion,nil];
    agrupacionAnimaciones.duration = 5.0;
    agrupacionAnimaciones.repeatCount= 8.0;
    // Add the animation to the layer.
